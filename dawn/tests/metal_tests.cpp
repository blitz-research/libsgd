...
void render() {
	...
	drawHelloTriangle(device, renderTarget);
	...
	copyTexture(device, renderTarget, surfaceTexture.texture);
...
int main() {
	...
	static auto resizeRenderTarget = [=](CVec2u size) {
