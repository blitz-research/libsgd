...
auto init = onInitActorTypes([] {
	...
	g_shoot = sgd_LoadSound("sgd://skirmish/player-shoot.wav");
});
...
Player::Player() : Actor(ActorType::player) {
	...
	sgd_MoveEntity(m_entity, Game::gridSize * .5f, 2.5f, Game::gridSize * .5f);
	...
	sgd_MoveEntity(m_camera, 0, 0.5f, 0);
...
void Player::onUpdate() {
	...
	static constexpr SGD_Real speed = .25f;
