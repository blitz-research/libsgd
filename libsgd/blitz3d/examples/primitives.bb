...
Local mesh5 = CreateBoxMesh(-r2, -r2, 0, r2, r2, 0, material)
Local model5 = CreateModel(mesh5)
MoveEntity model5, 0, 1.25, 0
...
Local collider5=CreateMeshCollider(model5,0,0)
