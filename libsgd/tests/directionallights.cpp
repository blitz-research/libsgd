...
void start() {
	...
	SGD_Material material = sgd_LoadMaterial("Bricks076C_1K-JPG");
	...
	// Pointing rightwards
	SGD_Light light0 = sgd_CreateLight(SGD_LIGHT_TYPE_DIRECTIONAL);
	sgd_SetLightColor(light0, 1, 0, 0, 1);
	sgd_TurnEntity(light0, 0, -90, 0);

	// Pointing leftwards
	SGD_Light light1 = sgd_CreateLight(SGD_LIGHT_TYPE_DIRECTIONAL);
	sgd_SetLightColor(light1, 0, 1, 0, 1);
	sgd_TurnEntity(light1, 0, 90, 0);

	// Pointing downwards
	SGD_Light light2 = sgd_CreateLight(SGD_LIGHT_TYPE_DIRECTIONAL);
	sgd_SetLightColor(light2, 0, 0, 1, 1);
	sgd_TurnEntity(light2, -90, 0, 0);

	// Pointing upwards
	SGD_Light light3 = sgd_CreateLight(SGD_LIGHT_TYPE_DIRECTIONAL);
